    ...
    <section className="py-12 sm:py-16 bg-studio-card/30 border-y border-studio-border">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-studio-ivory">Raw Capture vs. Photophactory Grade</h2>
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image
              ...
              alt="Photophactory Signature Grade"
              fill
